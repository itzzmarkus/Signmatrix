      ...
      <div className="max-w-4xl mx-auto p-6 w-full space-y-4">
        ...
        <div className="flex justify-center mb-6 mt-4">
          <button
            ...
            className={`flex items-center gap-2 px-6 py-2 rounded-lg font-bold text-white transition-all ${isDownloading ? 'bg-orange-600/50 cursor-not-allowed' : 'bg-orange-600 hover:bg-orange-500 active:scale-95'}`}
          >
            {isDownloading ? (
              <>
